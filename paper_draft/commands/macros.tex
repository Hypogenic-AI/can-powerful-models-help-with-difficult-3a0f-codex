...
\newcommand{\audit}{\textsc{Research Audit}\xspace}
\newcommand{\ordinary}{\textsc{Ordinary}\xspace}
\newcommand{\safetyaware}{\textsc{Safety-Aware}\xspace}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DATASET NAMES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newcommand{\auditset}{\textsc{Research-Agent Audit}\xspace}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MODEL NAMES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newcommand{\qwenfour}{\textsc{Qwen3-4B}\xspace}
\newcommand{\qweneight}{\textsc{Qwen3-8B}\xspace}
\newcommand{\qwenfourteen}{\textsc{Qwen3-14B}\xspace}
